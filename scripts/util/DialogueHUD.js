class DialogueHUD 
{
  ...
  createDialogueWindow()
  {
    ...
    this.characterName = currentScene.add.text(140, 60, "", { fontFamily: boldFontName, fontSize: 20 *textRatio, color: '#f9e26e', align: 'right',
    wordWrap: {width: 110},
    ...
    this.dialogueText = currentScene.add.text(300, 45, "", { fontFamily: regularFontName, fontSize: 25 *textRatio , color: '#f9e26e', align: 'left',
    wordWrap: {width: 530},
    wordWrapUseAdvanced: true
    });
  ...
  {
    let xOption = currentScene.add.text(xPosition, yPosition, optionName, { fontFamily: boldFontName, fontSize: 20 *textRatio , color: '#f9e26e', align: 'center',
    wordWrap: {width: 110},
    wordWrapUseAdvanced: true
    });
